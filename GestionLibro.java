...
public class GestionLibro extends javax.swing.JFrame {
    ...
    private void actualizarDatos(){
        ...
        int fila = jTableVerLibros.getSelectedRow();
        
        String id = jTableVerLibros.getValueAt(fila, 0).toString();
        String titulo = jTableVerLibros.getValueAt(fila, 1).toString();
        String autor = jTableVerLibros.getValueAt(fila, 2).toString();
        String editorial = jTableVerLibros.getValueAt(fila, 3).toString();
        String año = jTableVerLibros.getValueAt(fila, 4).toString();
        
        try {
            consultaSQL = conexion.prepareStatement("UPDATE libros SET titulo='"+titulo+"',autor='"+autor+"',editorial='"+editorial+"',año='"+año+"'WHERE codigo_libro = '"+id+"'");
